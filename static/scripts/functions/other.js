...
function profile_list_block_attach(_this, url, actions_class) {
  ...
  request.onreadystatechange = function () {
    if ( request.readyState == 4 && request.status == 200 ){
       ...
       _this.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.innerHTML = elem_.querySelector(block).innerHTML;
